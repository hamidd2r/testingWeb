	...
	function PageLoad() {
			...
			$('body').waitForImages({
				finished: function () {
					...
					setTimeout(function () {
						...
						gsap.set($("#showcase-carousel-holder .swiper-slide-active").prev().prev(), {
							x: -slideWidth,
							opacity: 0
						});
						gsap.set($("#showcase-carousel-holder .swiper-slide-active").next().next(), {
							x: slideWidth,
							opacity: 0
						});
						gsap.set($("#showcase-carousel-holder .swiper-slide-active").prev(), {
							x: -slideWidth,
							opacity: 0
						});
						gsap.set($("#showcase-carousel-holder .swiper-slide-active").next(), {
							x: slideWidth,
							opacity: 0
						});
						gsap.to($("#showcase-carousel-holder .swiper-slide-active").prev().prev(), {
							duration: 0.7,
							x: 0,
							delay: 0.9,
							opacity: 1,
						...
						gsap.to($("#showcase-carousel-holder .swiper-slide-active").next().next(), {
							duration: 0.7,
							x: 0,
							delay: 0.9,
							opacity: 1,
						...
						gsap.to($("#showcase-carousel-holder .swiper-slide-active").prev(), {
							duration: 0.7,
							x: 0,
							scale: 1,
							delay: 0.7,
						...
						gsap.to($("#showcase-carousel-holder .swiper-slide-active").next(), {
							duration: 0.7,
							x: 0,
							scale: 1,
							delay: 0.7,
		...
		if (!$('body').hasClass("disable-ajaxload")) {
			...
			var swapOpts = {
				...
				duration: 0.7, //Vineet changed from 0 to 0.5
		...
		if (!$("body").hasClass("disable-ajaxload")) {
			...
			$('.next-ajax-link-project').on('click', function () {
				...
				$(".temporary-hero .next-hero-title span").each(function (index, element) {
					TLNextHeroTitleSpan.to(element, {
						duration: 0.5,
						y: -140,
						opacity: 0,
						delay: 0.1,
		...
		if ($('#showcase-carousel-holder').length > 0) {
			...
			if (!isMobile()) {
				...
				$("#showcase-carousel-holder .swiper-slide").on('mouseenter', function () {
					gsap.set($(this).find('.slide-arrow span'), {
						y: 30,
						opacity: 0,
					});
					gsap.set($(this).find('.slide-subtitle span'), {
						y: 30,
						opacity: 0,
					});
					...
					gsap.to($(this).find('.slide-arrow span'), {
						duration: 0.3,
						y: 0,
						opacity: 1,
						delay: 0,
					...
					gsap.to($(this).find('.slide-subtitle span'), {
						duration: 0.3,
						y: 0,
						opacity: 1,
						delay: 0,
		...
		if ($('.portfolio-wrap').length > 0) {
			...
			if (!isMobile()) {
				...
				$(".item-parallax").on('mouseenter', function () {
					gsap.set($(this).find('.item-arrow i'), {
						y: 30,
						opacity: 0,
					});
					gsap.set($(this).find('.item-cat span, .item-date span'), {
						y: 30,
						opacity: 0,
					});
					gsap.set($(this).find('.item-title span'), {
						y: 60,
						opacity: 0,
					});
					gsap.to($(this).find('.item-arrow i'), {
						duration: 0.3,
						y: 0,
						opacity: 1,
						delay: 0,
					...
					gsap.to($(this).find('.item-cat span, .item-date span'), {
						duration: 0.3,
						y: 0,
						opacity: 1,
						delay: 0,
					...
					gsap.to($(this).find('.item-title span'), {
						duration: 0.5,
						y: 0,
						opacity: 1,
						delay: 0.1,
