...
class GridToFullscreenEffect {
    ...
    createTextures(e) {
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            const s = new THREE.Texture(r.small.image);
            s.generateMipmaps = !1, s.wrapS = s.wrapT = THREE.ClampToEdgeWrapping, s.minFilter = THREE.LinearFilter, s.needsUpdate = !0;
            const o = {
                large: {
    ...
    init() {
        ...
        this.mesh = new THREE.Mesh(n, s), this.scene.add(this.mesh), window.addEventListener("resize", this.onResize), this.options.scrollContainer && this.options.scrollContainer.addEventListener("scroll", e => {
            this.recalculateUniforms(e)
        });
        for (let e = 0; e < this.itemsWrapper.children.length; e++) {
            this.itemsWrapper.children[e].children[0].addEventListener("mousedown", this.createOnMouseDown(e))
        }
    }
    createOnMouseDown(e) {
        return n => {
    ...
    recalculateUniforms(e) {
        if (-1 === this.currentImageIndex) return;
        const n = this.itemsWrapper.children[this.currentImageIndex].children[0].getBoundingClientRect(),
            t = {
        ...
        const i = this.getViewSize(),
            s = n.width * i.width / window.innerWidth,
            o = n.height * i.height / window.innerHeight,
            a = n.left * i.width / window.innerWidth - i.width / 2,
            l = n.top * i.height / window.innerHeight - i.height / 2,
            u = (this.mesh.geometry, this.mesh);
        u.scale.x = s, u.scale.y = o;
        let c = a + s / 2,
            m = -l - o / 2;
        u.position.x = c, u.position.y = m, this.uniforms.uPlaneCenter.value.x = c / s, this.uniforms.uPlaneCenter.value.y = m / o, this.uniforms.uMeshScale.value.x = s, this.uniforms.uMeshScale.value.y = o, this.uniforms.uScaleToViewSize.value.x = i.width / s - 1, this.uniforms.uScaleToViewSize.value.y = i.height / o - 1
    }
    toFullscreen(e, n) {
...
const transformations = {
    ...
    simplex: e => {
        ...
        let n = ensureFloat(e.amplitudeX || .5),
            ...
            s = ensureFloat(e.progressLimit || .5);
